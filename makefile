...
all: ogl_utils.o egl_utils.o dividers_gl.o liquid_gl.o exit_menu_gl.o image_gl.o cursor_gl.o rectangle_gl.o
	
	mkdir -p bin
	$(CC) $(CFLAGS) $(INCLUDES) $(LDFLAGS) ogl_utils.o egl_utils.o dividers_gl.o liquid_gl.o exit_menu_gl.o image_gl.o cursor_gl.o rectangle_gl.o lodepng.c background_gl.c font_gl.c particles_gl.c mover_gl.c controls.c renderer.c geometry.c hash.c communication.c fluid.c -o bin/sph.out
